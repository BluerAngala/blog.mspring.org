...
function add_copyright () {
  ...
  function setClipboardText (event) {
    ...
    var htmlData = '------<br>注意：' + '著作权归作者所有。' + '商业转载请联系作者获得授权，非商业转载请注明出处。<br>' + '作者：' + mashiro_option.author_name + '<br>' + '来源：' + mashiro_option.site_name +  '<br>'  +  '原文链接：' + window.location.href +'<br>------<br><br>' + window.getSelection().toString().replace(/\r\n/g, '<br>')
    var textData = '------\n注意：' + '著作权归作者所有。' + '商业转载请联系作者获得授权，非商业转载请注明出处。\n' + '作者：' + mashiro_option.author_name + '\n' + '来源：' + mashiro_option.site_name +  '\n' +  '原文链接：' + window.location.href +'\n------\n\n' + window.getSelection().toString().replace(/\r\n/g, '\n')
